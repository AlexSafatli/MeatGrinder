...
arminj = [['slight', '-1 DX %s (incl. two-handed tasks).' % franyaction],
          ['HP/5-HP/3', '-3 DX %s (incl. two-handed tasks).' % franyaction],
          ['HP/3-HP/2',
           'The arm is almost broken; Will roll to use; success at -5 DX.'],
          ['>HP/2', 'Crippled'], ['>HP', 'Severed']]
leginj = [['slight', '-1 DX %s and with good leg if standing.' % franyaction],
          ['HP/5-HP/3',
           '-3 DX %s and -1 with good leg if standing.' % franyaction],
          ['HP/3-HP/2', 'The leg is almost broken; Will roll to use.'],
          ['>HP/2', 'Crippled'], ['>HP', 'Severed']]
...
inj = {'Right Arm': arminj, 'Left Arm': arminj, 'Arm': arminj,
       ...
       'Torso': [['HP/3', '-1 DX for all purposes.'],
                 ['HP/2', '-2 DX, Move is 80 percent normal.'],
